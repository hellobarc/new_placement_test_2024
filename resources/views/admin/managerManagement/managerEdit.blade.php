    ...
    <div class="container">
        <div class="row">
            <div class="col-auto mt-2">
                <p class="fs-3 fw-bold">Manager Management : Edit An Existing Manager</p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-10 mx-auto">
                <form action="{{ route('manager.edit.store') }}" method="POST" class="form-control">
                    @csrf 
                    ...
                    <div class="row my-2 mx-2">
                        ...
                        <select name="status" id="" class="form-control">
                            ...
                            <option value="pause" {{ $getUserData->status=='pause' ? 'selected' : '' }}>Inactive</option>
                        </select>
                    </div>
                    <div class="row my-2 mx-2">
                        <div class="col-2">
