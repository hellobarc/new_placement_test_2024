    ...
    <div class="row">
        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card mt-3 p-4">
                ...
                <form action="{{route('admin.store.section.test')}}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="mb-3">
					  <label for="name" class="form-label">Section Name<span class="text-danger">*</span></label>
					  <input type="text" class="form-control" name="name" placeholder="Enter test title">
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
					  ...
					  <textarea name="instruction" class="form-control" id=""></textarea>
					</div>
