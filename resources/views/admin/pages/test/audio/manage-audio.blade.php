						...
						<tbody>
							@foreach ($data as $rows)
								<tr>
									...
									<td>
										<audio controls src="{{asset('admin/files/uploads/test-audio/'.$rows->audio)}}" type="audio/mpeg"></audio>
									</td>
									<td>
										<a href="{{route('admin.test.edit-audio', $rows->id)}}" class="btn btn-primary btn-sm">Edit</a>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<a href="{{route('admin.test.delete-audio', $rows->id)}}" class="btn btn-danger mt-2">Permanent Delete</a>
											</div>
