                                        ...
                                        @foreach ($data as $items)
                                            ...
                                            @elseif($items['question_type'] == 'writing')
                                                ...
                                                <div class="question_set_3 mb-3">
                                                    ...
                                                    <p class="main-text" style="color: #f02828 !important;">{!!$items['question_instruction']!!}</p>
                                                    @if($items['sub-q'] != NULL)
                                                        @foreach ($items['sub-q'] as $question)
                                                            ...
                                                            <textarea name="wrting_question" id="textArea" rows="10" class="w-100" onpaste="return false;" ondrop="return false;" spellcheck="false" autocomplete="off" autocorrect="off" autocapitalize="off" data-gramm="false" data-gramm_editor="false" data-enable-grammarly="false" placeholder="Start writing from here..."></textarea>
