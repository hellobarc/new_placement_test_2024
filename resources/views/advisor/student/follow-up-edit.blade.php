    ...
    <div class="row">
        ...
        <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <div class="card p-4 shadow-sm border-none" style="margin: 20px 20px !important;">
                <h3 class="text-center fw-bold" style="color: #035388">Edit Follow Up</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('update.followUP', $data->id ) }}" method="POST">
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn fw-bold text-white mt-4" style="background-color: #035388">Update Follow Up</button>
                        </div>
                    </form>
