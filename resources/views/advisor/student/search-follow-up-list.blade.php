    ...
    <div class="row">
        ...
        <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12 mt-3">
            <div class="card p-4 shadow-sm border-none" style="margin: 20px 20px !important;">
                <h3 class="text-center fw-bold" style="color: #035388">Search Follow Up List</h3>
                    ...
                    <table class="table table-striped table-bordered" style="margin-top:32px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $data->remarks }}</td>
                                <td>
                                    <a href="{{ route('visitor.follow-up.edit', $data->id )}}" class="btn btn-success btn-sm"><i class="fa-regular fa-pen-to-square"></i> Edit</a>
