            ...
            <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12 mx-auto">
                <div class="visitor_info_div">
                    ...
                    <div style="padding:10px 20px; border-radius:5px" class="text-center">
                        <h1 style="color:#035388; font-weight:600;">Visitor Infromation Form</h1>
                    </div>
                    <div class="row">
                            ...
                            <form action="{{ route('store.VisitorInfo')}} " method="POST">
                                ...
                                <div class="row mt-5">
                                    <div class="mx-auto mt-10 text-center col">
                                        <input  type="submit" class="text-center btn px-5 py-2 text-white fw-bold" value="Submit" style="background-color:#035388;">
                                    </div>
                                </div> 
                            </form>
                        </div>
