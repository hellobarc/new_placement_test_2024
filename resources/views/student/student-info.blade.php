            ...
            <div class="card mt-2">
                <div class="card-body">
                    <div style="background: #fbc8be; padding:10px 20px; border-radius:5px">
                        <h1 class="fw-bold">Assessment Your Level</h1>
                       ...
                       @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="adviser_id" required>
                                        <option value="">Select Adviser</option>
                                            <option value="2">Afrin Rahman</option>
                                            <option value="4">Munjerin Firoz (Shoma)</option>
                                            <option value="6">Saida Tanjin</option>
                                            <option value="7">Mousumi Anwar</option>
                                            <option value="8">Sharmin Akter</option>
                                            <option value="10">Golam Muktadir</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input name="date_of_birth" id="date_of_birth" type="date" class="form-control" placeholder="Date of Birth" required>
                                </div>
                            </div>
                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                        ...
                        <div class="row mt-4">
                            <div class="mx-auto mt-10 text-center col">
                                <input  type="submit" class="text-center btn text-white fw-bold" value="Start Assessment" style="background:rgba(121,38,225,1)">
                            </div>
                        </div> 
                    </form>
                </div>
