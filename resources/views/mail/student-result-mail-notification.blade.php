          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
            ...
            <tr>
              <td style="padding:20px 30px;background-color:#ffffff;">
                ...
                <p style="margin:0; font-weight: 600; color:#181818; font-size: 1rem;letter-spacing: 0.0225rem;">Minar Ahmed</p>
                  <p style="font-size: 0.875rem;line-height: 1.325rem;letter-spacing: 0.015rem;color: #2F2E2E;margin: 7px 0 35px 0;">
                    ...
                    এবং আপনার অবস্থান <span style="color:#2268D1; font-size:1rem">A2 level</span> এ.
                  </p>
                  <img src="{{ asset('frontend\images\result-card\a1_cefr_level.svg') }}" alt="" style="width: 100%; height:auto; margin-bottom: 20px;">
                  <div style="border: 1px solid #004AAD; width:70%; margin:auto; margin-top: 1rem !important; border-radius: 4px;">
                      ...
                      <div style="padding: 10px 20px;">
                          ...
                          <div style="display: inline">
                            <progress class="progress-bar-listening" value="30" max="100"></progress>
                            <div style="text-align:end;">30%</div>
                          </div>
                          <p style="margin: 0 0 0 0; font-size: 1rem;font-weight: 600;">Listening</p>
                          <div style="display: inline">
                            <progress class="progress-bar-reading" value="30" max="100"></progress>
                            <div style="text-align:end;">30%</div>
                          </div>
                          <p style="margin: 0 0 0 0; font-size: 1rem;font-weight: 600;">Writing</p>
                          <div>
                            <progress class="progress-bar-writing" value="30" max="100"></progress>
                            <div style="text-align:end;">30%</div>
                          </div>
                      </div>
                  </div>
                    <div style="border: 1px solid #36A0ED; width:70%; margin:auto; margin-top: 2rem !important; border-radius: 4px;">
                      <div style="background-color:#36A0ED; text-align:center; color:#f8f8f8;font-size: 0.9375rem;font-weight: 600;line-height: 1.86863rem; letter-spacing: 0.01875rem;"> টার্গেট স্কোর এবং  বর্তমান অবস্থা</div>
                      <div style="padding: 10px 20px;">
                  ...
                  <div style="font-size: 1.125rem; margin-top: 2rem !important; margin-bottom: 0.875rem !important; font-weight: 700; line-height: 1.6rem;">Band 4 থেকে band 7 এ যেতে যে কোর্সগুলো করতে হবে</div>
                    <table>
                      <tr>
                        <td>
                          <div style="border: 1px solid #004AAD; border-radius: 4px; padding: 5px 8px;">
                            <!-- cross  icon -->
                            ...
                            <span style="color: #4D4B4B; font-size: 0.875rem; font-weight: 600; line-height: 1.3125rem;">A1 Level</span>
                          </div>
                        </td>
                        <td>
                          <div style="border: 1px solid #004AAD; border-radius: 4px; padding: 5px 8px; margin-left: 0.325rem !important;">
                            <!-- correct  icon -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" fill="none">
                            ...
                            <span style="color: #4D4B4B; font-size: 0.875rem; font-weight: 600; line-height: 1.3125rem;">A2 Level</span>
                          </div>
                        </td>
                        <td>
                          <div style="border: 1px solid #004AAD; border-radius: 4px; padding: 5px 8px; margin-left: 0.325rem !important;">
                            ...
                            <span style="color: #4D4B4B; font-size: 0.875rem; font-weight: 600; line-height: 1.3125rem;">B1 Level</span>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <div style="border: 1px solid #004AAD; border-radius: 4px; padding: 5px 8px; margin-top: 0.625rem !important;">
                            <!-- correct  icon -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" fill="none">
                              <path d="M6.93295 12.8453C3.74206 12.8453 1.15549 10.2337 1.15549 7.01198C1.15549 3.79023 3.74206 1.17865 6.93295 1.17865C10.1238 1.17865 12.7104 3.79023 12.7104 7.01198C12.7104 10.2337 10.1238 12.8453 6.93295 12.8453ZM6.35694 9.34532L10.4416 5.22057L9.62467 4.39573L6.35694 7.69565L4.7225 6.0454L3.90556 6.87023L6.35694 9.34532Z" fill="#004AAD"/>
                            </svg>
                            <span style="color: #4D4B4B; font-size: 0.875rem; font-weight: 600; line-height: 1.3125rem;">B2 Level</span>
                          </div>
                        </td>
                        <td>
                          <div style="border: 1px solid #004AAD; border-radius: 4px; padding: 5px 8px; margin-top: 0.625rem !important; margin-left: 0.325rem !important;">
                            <!-- correct  icon -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" fill="none">
                              <path d="M6.93295 12.8453C3.74206 12.8453 1.15549 10.2337 1.15549 7.01198C1.15549 3.79023 3.74206 1.17865 6.93295 1.17865C10.1238 1.17865 12.7104 3.79023 12.7104 7.01198C12.7104 10.2337 10.1238 12.8453 6.93295 12.8453ZM6.35694 9.34532L10.4416 5.22057L9.62467 4.39573L6.35694 7.69565L4.7225 6.0454L3.90556 6.87023L6.35694 9.34532Z" fill="#004AAD"/>
                            </svg>
                            <span style="color: #4D4B4B; font-size: 0.875rem; font-weight: 600; line-height: 1.3125rem;">C1 Level</span>
                          </div>
                        </td>
                      </tr>
                    </table>
                  <div style="margin-top:1.5rem !important;">
                    ...
                    <div style="color: #222;font-size: 0.875rem;font-weight: 700;line-height: 1.125rem; margin:5px 0;"> গোলাম মুকতাদির</div>
                    <div style="color: #222;font-size: 0.875rem;font-weight: 400;line-height: 1.125rem;"> অ্যাসিস্ট্যান্ট ম্যানেজার</div>
                    <div style="color: #222;font-size: 0.875rem;font-weight: 400;line-height: 1.125rem; margin-top:5px;">ব্রিটিশ আমেরিকান রিসোর্স সেন্টার, ০১৬১৭-৩০২০১০</div>
                  </div>
